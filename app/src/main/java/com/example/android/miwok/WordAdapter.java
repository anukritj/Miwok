...
public class WordAdapter extends ArrayAdapter<Word>  {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        defaultTextView.setText(currentWord.getDefaultTranslation());
            ...
            // Get the default translation from the currentWord object and set this image on
            // the miwok ImageView.
        ...
        // Return the whole list item layout (containing 2 TextViews and 1 Image View) so that it can be shown in
        // the ListView.
        return listItemView;
    }
}