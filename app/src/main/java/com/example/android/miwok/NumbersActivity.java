...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<words.size();i++){
            Log.v("NumberActivity","Index: "+i+"Value: "+words.get(i));
        }

        /*LinearLayout rootView= (LinearLayout) findViewById(R.id.rootView);  ALTERNATE METHOD

        for(int i=0;i<words.size();i++){
            TextView wordView= new TextView(this);
            wordView.setText(words.get(i));
            wordView.setPadding(16,0,0,0);
    ...
    //When the activity is stopped on the device, this function makes sure that the sound interrupted does not continue to play.
